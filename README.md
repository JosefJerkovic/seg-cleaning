...
<head>
  ...
  <style>
    ...
    .hero {
      padding: 3em 2em;
      background: url('https://images.unsplash.com/photo-1581578017424-dc39c1bb61d1') no-repeat center/cover;
      color: white;
      text-align: center;
    }
    section {
...
<section id="cjenik">
  ...
  <div class="price-table">
    ...
    <h3>Vile, kuće za odmor / Villas / Ferienhäuser</h3>
    <ul>
